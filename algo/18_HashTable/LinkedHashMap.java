...
public class LinkedHashMap<K, V> extends HashMap<K, V> implements Map<K, V> {
   ...
   * resize. It is overridden for performance, as it is faster to iterate using
   * our linked list.
   */
  ...
  private static class Entry<K, V> implements HashMap.Entry<K, V> {
     ...
     * entry is read by Map.get or modified by Map.set. If the enclosing Map is
     * access-ordered, it moves the entry to the end of the list; otherwise, it does
     * nothing.
     */
  ...
  public class EntryIterator extends LinkedHashIterator<Map.Entry<K, V>> {
   ...
   * allocated entry to get inserted at the end of the linked list and removes the
   * eldest entry if appropriate.
   */
  ...
  /**
   * Returns <tt>true</tt> if this map should remove its eldest entry. This method
   * is invoked by <tt>put</tt> and <tt>putAll</tt> after inserting a new entry
   * into the map. It provides the implementor with the opportunity to remove the
   ...
   * <i>must</i> return <tt>false</tt> (indicating that the map should not attempt
   * any further modification). The effects of returning <tt>true</tt> after
   * modifying the map from within this method are unspecified.
   *
   * <p>
   * This implementation merely returns <tt>false</tt> (so that this map acts like
